...
const projects = [
  ...
  {
    title: 'Dashboard Analytics5',
    desc: 'Panel de métricas con gráficas en tiempo real e integración completa con WooCommerce REST API.',
    tags: ['React', 'Chart.js', 'REST API'],
  },
  {
    title: 'Dashboard Analytics6',
    desc: 'Panel de métricas con gráficas en tiempo real e integración completa con WooCommerce REST API.',
    tags: ['React', 'Chart.js', 'REST API'],
  },
  {
    title: 'Dashboard Analytics7',
    desc: 'Panel de métricas con gráficas en tiempo real e integración completa con WooCommerce REST API.',
    tags: ['React', 'Chart.js', 'REST API'],
  },
  {
    title: 'Dashboard Analytics8',
    desc: 'Panel de métricas con gráficas en tiempo real e integración completa con WooCommerce REST API.',
    tags: ['React', 'Chart.js', 'REST API'],
  },
  {
    title: 'Dashboard Analytics9',
    desc: 'Panel de métricas con gráficas en tiempo real e integración completa con WooCommerce REST API.',
    tags: ['React', 'Chart.js', 'REST API'],
  },
  {
    title: 'Dashboard Analytics10',
    desc: 'Panel de métricas con gráficas en tiempo real e integración completa con WooCommerce REST API.',
    tags: ['React', 'Chart.js', 'REST API'],
  },
  {
    title: 'Dashboard Analytics11',
    desc: 'Panel de métricas con gráficas en tiempo real e integración completa con WooCommerce REST API.',
    tags: ['React', 'Chart.js', 'REST API'],
  },
]
